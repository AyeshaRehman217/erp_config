...
public class SlaveCustomTimeZoneMapper implements BiFunction<Row, Object, SlaveTimezoneEntity> {

    @Override
    public SlaveTimezoneEntity apply(Row source, Object o) {

        return SlaveTimezoneEntity.builder()
                ...
                .gmtOffset(source.get("gmt_offset", String.class))
                .zoneName(source.get("zone_name",String.class))
                .gmtOffsetName(source.get("gmt_offset_name", String.class))
                .abbreviation(source.get("abbreviation", String.class))
                .tzName(source.get("tz_name", String.class))
