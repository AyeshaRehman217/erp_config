...
public class SlaveCustomCityMapper implements BiFunction<Row, Object, SlaveCityEntity> {

    @Override
    public SlaveCityEntity apply(Row source, Object o) {

        return SlaveCityEntity.builder()
                ...
                .postalCode(source.get("postal_code", String.class))
