...
@NoArgsConstructor
@AllArgsConstructor
@Table("public.\"sub_administration_departments\"")
public class SlaveSubAdministrationDepartmentEntity {
    @Id
    @Column
    private Long id;
    ...
    @Column("administration_department_uuid")
    private UUID administrationDepartmentUUID;

    @Column("sub_administration_department_uuid")
    private UUID subAdministrationDepartmentUUID;
