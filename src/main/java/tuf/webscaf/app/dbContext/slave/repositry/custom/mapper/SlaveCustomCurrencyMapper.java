...
public class SlaveCustomCurrencyMapper implements BiFunction<Row, Object, SlaveCurrencyEntity> {

    @Override
    public SlaveCurrencyEntity apply(Row source, Object o) {

        return SlaveCurrencyEntity.builder()
                ...
                .currencyName(source.get("currency_name", String.class))
                .description(source.get("description", String.class))
                .currency(source.get("currency", String.class))
                .currencySymbol(source.get("currency_symbol", String.class))
                .isoNumber(source.get("iso_number", Integer.class))
