...
public class SlaveCustomBranchWithBranchProfileMapper implements BiFunction<Row, Object, SlaveBranchWithBranchProfileDto> {
    //    MultiValueMap<Long, SlaveAccountGroupEntity> accountWithAccountGroupMap=new LinkedMultiValueMap<>();
    @Override
    public SlaveBranchWithBranchProfileDto apply(Row source, Object o) {


        return SlaveBranchWithBranchProfileDto.builder()
                ...
                .branchProfileUUID(source.get("branch_profile_uuid", UUID.class))
