...
public class SlaveCustomLanguageMapper implements BiFunction<Row, Object, SlaveLanguageEntity> {

    @Override
    public SlaveLanguageEntity apply(Row source, Object o) {

        return SlaveLanguageEntity.builder()
                ...
                .languageCode(source.get("language_code", String.class))
